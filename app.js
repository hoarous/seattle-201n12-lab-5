...
function sumArray(sumArr) { //eslint-disable-line
  var summed = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
  var concatenated = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + summed + ' is their sum.';
  var returnArray = [summed, concatenated];
  return returnArray;
}
